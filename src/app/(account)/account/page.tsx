...
export default async function AccountPage() {
  ...
  const cards = [
    { href: "/orders", label: t.auth.orders, emoji: "📦", soon: false },
    { href: "/favorites", label: t.auth.favorites, emoji: "♥", soon: false },
    { href: "/addresses", label: t.auth.addresses, emoji: "📍", soon: false },
    { href: "/my-listings", label: t.auth.listings, emoji: "🚲", soon: false },
  ];
