...
- **İlan fiyatı = site birimi:** ilan formundaki fiyat, sitede seçili para biriminde girilir (`currency` hidden), `createListing` TRY kuruşa çevirip saklar; `/ilanlarim` seçili birimde gösterir → site birimi değişince ilan da değişir.
